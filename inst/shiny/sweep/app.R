...
g1 <- g + geom_histogram(color = "black", fill = lcars_colors("melrose"), bins = 20) +
  ggtitle("Plot 1")
g2 <- g + geom_histogram(color ="black", fill = lcars_colors("golden-tanoi"), bins = 20) +
  ggtitle("Plot 2")
...
note <- p("Note: using 100% width is not recommended due to limitations in responsiveness.")
